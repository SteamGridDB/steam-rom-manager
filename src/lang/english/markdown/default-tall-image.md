...
Allows to use image, stored locally, as a default/fallback tall image. A [special glob input](#special-glob-input) string is used to retrieve images. Only the first retrieved image is used.
