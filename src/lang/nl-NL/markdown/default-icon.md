# Standaardpictogram (optioneel) `[ondersteunt variabelen]`{.noWrap}

Hiermee kan een lokaal opgeslagen afbeelding worden gebruikt als standaard-/terugvalpictogram. Een [speciale glob invoer](#special-glob-input) string wordt gebruikt om afbeeldingen op te halen. Alleen de eerste opgehaalde afbeelding wordt gebruikt.
...
Ja, zodra de lijst is opgeslagen, wordt het standaardpictogram gekopieerd naar een Steam-map waar ze worden hernoemd om overeen te komen met de APP-ID van Steam.
