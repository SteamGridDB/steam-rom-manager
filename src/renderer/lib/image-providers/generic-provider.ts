...
export class GenericProviderManager<T extends GenericProvider> {
    ...
    newInstance(id: string, title: string) {
        return this.instanceMap.set(id, new this.provider(new ProviderProxy(id, title, this)));
    }
                ...
                case 'retrieveUrls':
                    {
                        ...
                        this.newInstance(data.id, data.title).get(data.id).retrieveUrls();
                    }
                    break;
                case 'stopDownloads':
                    {
...
export class ProviderProxy {
    constructor(private _id: string, private _title: string, private _manager: GenericProviderManager<GenericProvider>) { }
