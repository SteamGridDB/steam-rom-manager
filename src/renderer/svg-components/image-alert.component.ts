...
@Component({
    ...
    template: `
        <svg:g>
            <svg:g>
                <svg:path d="M496.899,381.746L353.57,153.019l-46.084-76.807c-11.976-22.131-32.414-34.108-52.852-34.108
        ...
        <svg:g>
            <svg:g>
                <svg:path d="M268.172,381.746c-6.899-6.77-17.053-6.77-23.953,0c-3.385,3.385-5.077,8.591-5.077,11.977
        ...
        <svg:g>
            <svg:g>
                <svg:path d="M256.195,139.349c-8.592,0-17.054,8.591-17.054,17.053v13.669v182.643c0,10.285,6.769,17.053,17.054,17.053
