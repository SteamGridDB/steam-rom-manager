...
@Component({
    ...
    template: `
        <svg:polyline points="50,110 150,210 250,110"/>
    `,
    host: {
        viewBox: "0 0 300 300",
        version: "1.1",
    ...
    styles: [`
        ...
        :host(.hover):hover{
            background-color: var(--select-arrow-down-background-hover, transparent);
        }
        :host(.active):active{
            background-color: var(--select-arrow-down-background-active, transparent);
        }
