...
@Component({
    ...
    template: `
        <svg:polyline points="220,50 100,150 220,250"/>
    `,
    host: {
        viewBox: "0 0 300 300",
        version: "1.1",
    ...
    styles: [`
        ...
        :host(.hover):hover{
            background-color: var(--select-arrow-left-background-hover, transparent);
        }
        :host(.active):active{
            background-color: var(--select-arrow-left-background-active, transparent);
        }
