...
@Component({
    ...
    template: `
        <svg:polyline points="80,50 200,150 80,250"/>
    `,
    host: {
        viewBox: "0 0 300 300",
        version: "1.1",
    ...
    styles: [`
        ...
        :host(.hover):hover{
            background-color: var(--select-arrow-right-background-hover, transparent);
        }
        :host(.active):active{
            background-color: var(--select-arrow-right-background-active, transparent);
        }
